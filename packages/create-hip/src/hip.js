...
export function createHipModelFromAnswers(answers = DEFAULT_ANSWERS, overrides = {}) {
  return {
    ...
    humanOperatingMode: {
      ...
      'Decision style': overrides.decisionStyle ?? DEFAULT_OPERATING_MODE['Decision style'],
      'Feedback style': overrides.feedbackStyle ?? DEFAULT_OPERATING_MODE['Feedback style'],
    },
